...
ORCHESTRATOR_MODEL = os.environ.get("ORCHESTRATOR_MODEL", "gemini-2.5-flash")  # cheaper: gemini-3.1-flash-lite
WORKER_MODEL = os.environ.get("WORKER_MODEL", "gpt-5-nano")  # cheaper: gpt-5.4-mini